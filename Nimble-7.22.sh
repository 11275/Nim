...
function main_menu_ch(){
    ...
    echo "11. 新钱包地址挖矿----适用于未注册过的钱包地址  ) "
    echo "12. 老钱包地址挖矿----适用于已注册过的钱包地址  ) "
    echo "13. 查看当前nim进程  ) "
    echo "14. 关闭nim进程  ) "
    echo "===================================快捷启动（已经安装好了环境）多卡================================================================="
    echo "15. 新钱包地址多卡挖矿----适用于未注册过的钱包地址-----批量模式  ) "
    echo "16. 老钱包地址多卡挖矿----适用于已注册过的钱包地址-----批量模式  ) "
    echo "17. 新钱包地址多卡挖矿----适用于未注册过的钱包地址-----指定某张卡  ) "
    echo "18. 老钱包地址多卡挖矿----适用于已注册过的钱包地址-----指定某张卡  ) "
    echo "19. 查看当前多卡nim进程  ) "
    echo "20. 关闭多卡nim进程 --------批量模式 ) "
    echo "21. 关闭多卡nim进程 --------指定模式 ) "
    echo "22. 关闭多卡nim进程 --------指定模式------加重新启动----新钱包申请 ) "
    echo "23. 关闭多卡nim进程 --------指定模式------加重新启动----老钱包运行 ) "
    echo "=================================================辅助测试工具======================================================================="
    echo "24. 测试显卡驱动 ) "
    echo "25. 测试连接huggingface.co ) "
    echo "26. 显卡驱动安装 ) "
    echo "==================================================建议和参考========================================================================"
    echo "27. 相关参考和建议 "
    echo "28. 参考算力表 "
